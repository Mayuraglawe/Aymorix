export default function AboutTeam() {
    return (
        <section
            id="about"
            className="relative overflow-hidden border-b border-slate-200 bg-[linear-gradient(165deg,#f8fbff_0%,#f3f4ff_45%,#ffffff_100%)] py-16 md:py-24 max-[600px]:py-12"
        >
            ...
            <div className="relative mx-auto max-w-screen-xl px-4 sm:px-6 md:px-16">
                <div className="grid grid-cols-1 items-center gap-8 md:gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
                    <div className="relative">
                        <div className="relative overflow-hidden rounded-2xl md:rounded-[34px] border border-slate-200 bg-slate-950 shadow-[0_26px_70px_rgba(16,25,64,0.2)]">
                            <div className="absolute left-3 sm:left-5 top-3 sm:top-5 z-20 inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/15 px-2 sm:px-3 py-1 text-[9px] sm:text-[11px] font-semibold uppercase tracking-wide text-white backdrop-blur-sm">
                                Team Story
                            </div>

                            <video
                                className="h-[240px] sm:h-[300px] md:h-[420px] w-full object-cover"
                    ...
                    <div className="max-w-xl">
                        <span className="mb-3 md:mb-4 inline-block rounded-full border border-brand/20 bg-brand/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-brand">
                            About Us
                        </span>

                        <h2 className="font-display font-extrabold leading-[1.02] tracking-tight text-ink text-[clamp(1.75rem,5vw,3.5rem)]">
                            We Build
                            <br />
                            Digital Momentum
                        </h2>
